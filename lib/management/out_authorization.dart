...
/// Clase principal
class OutAuthorization extends StatelessWidget {
  ///  Class Key
  const OutAuthorization({Key? key}) : super(key: key);
  @override
...
class OutBody extends StatelessWidget {
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text('Salida de activos fuera de las instalaciones.',
                ...
                Text(
                  ...
                  ' del carnet del empleado, y verifique si tiene'
                  ' autorización.',
                                ...
                                children: [
                                  Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Ubicaciones donde se encuentran los activos:',
                                          style: Theme.of(context)
                                              .textTheme
                                              .headline6,
                                        ),
                                  ...
                                  Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          datos['Number'].toString(),
                                          style: Theme.of(context)
                                              .textTheme
                                              .headline6,
                                        ),
                                        Text(
                                          datos['StartDate'].toString(),
                                          style: Theme.of(context)
                                              .textTheme
                                              .headline6,
                                        ),
                                        Text(
                                          datos['EndDate'].toString(),
                                          style: Theme.of(context)
                                              .textTheme
                                              .headline6,
                                        ),
                        ...
                        ? Center(
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'El usuario: ${datos['User']} tiene'
                                    ' aún pendiente su autorización.',
                                    style:
                        ...
                        : Center(
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'El usuario: ${datos['User']} no tiene'
                                    ' autorizaciones o han sido rechazadas.',
                                    style:
                                        Theme.of(context).textTheme.headline5,
                                  ),
                                ],
...
Map<String, dynamic> searchUserAuthorization(
    ...
    for (final itemA in authorizations) {
      if (itemA.person!.contains(user.userName!)) {
        aux1 = '${user.name?.givenName}'
            ...
            '(${user.userName})';
        aux2 = itemA.number.toString();
        aux3 = itemA.authorizedStartDate!;
        aux4 = itemA.authorizedEndDate!;
        // ignore: prefer_foreach
        for (final asset in itemA.assets!) {
          if (!auxList1.contains(asset)) {
            auxList1.add(asset);
          }
        }
        aux5 = auxList1;
  ...
  final assetsAux = <Asset>[];
  for (final asset in aux5) {
    for (final assetInventory in assets) {
      if (assetInventory.assetCode == asset) {
        assetsAux.add(assetInventory);
        break;
      }
    }
  }
  ...
  if (user.userName != null && user.userName != '') {
    for (final itemC in companys) {
      for (final asset in assetsAux) {
        if (itemC.locations!.contains(asset.locationName)) {
          auxList.add(asset.locationName!);
        }
      }
    }
  }
  ...
  if (aux1.isEmpty) {
    if (user.userName != null && user.userName != '') {
      for (final itemA in authorizationsP) {
        if (itemA.person!.contains(user.userName!) &&
            itemA.status == 'Rechazada') {
          aux2 = '-3';
        }
        if (itemA.person!.contains(user.userName!) &&
            itemA.status == 'Pendiente') {
          aux2 = '-2';
        }
      }
    }
